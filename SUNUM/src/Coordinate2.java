...
public class Coordinate2 {
  ...
  public  ArrayList<Coordinate2> AllObjectXY=new ArrayList<>();
//  public  ArrayList<Coordinate2> Obstacle3XY=new ArrayList<>();
 // public  ArrayList<Coordinate2> Obstacle2XY=new ArrayList<>();
  public  ArrayList<Coordinate2> PassObjectXY=new ArrayList<>();
  public  ArrayList<Coordinate2>Obstacle1XY=new ArrayList<>();        
